...
Twin of figma-downloader-ts/src/cli.mjs. Same flags, same modes, same exit codes.
"""
...
def _run_inner(argv: list[str], env: dict) -> int:
    ...
    token = "mock-token" if args.get("mock") else (env.get("FIGMA_TOKEN") or env.get("FIGMA_API_TOKEN") or env.get("FIGMA_ACCESS_TOKEN") or "")
